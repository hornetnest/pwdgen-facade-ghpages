...
/***/ "./_js/modules/character-range.js":
/*!****************************************!*\
  !*** ./_js/modules/character-range.js ***!
  \****************************************/
/***/ (function() {
...
/***/ "./_js/modules/complexity-range.js":
/*!*****************************************!*\
  !*** ./_js/modules/complexity-range.js ***!
  \*****************************************/
...
/* harmony export */   "setBubble": function() { return /* binding */ setBubble; }
/* harmony export */ });
...
/***/ "./_js/modules/passwd.entrypoint.js":
/*!******************************************!*\
  !*** ./_js/modules/passwd.entrypoint.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
jQuery(function ($) {
  $(window).on("load", function (e) {
    ...
    _complexity_range__WEBPACK_IMPORTED_MODULE_1__.setBubble(bubble_range.get(0), bubble.get(0));
  });
});
...
const MAX_BITS_PER_NUMBER = 32; // we limit every operations to be within this amount of bits as all JS bitwise operations only operate on or produce 32 bits numbers
const MAX_CARDINALITY = MAX_UINT32 + 1;
...
function bitsToMapItem(cardinality) {
...
function binaryAlign(cardinality) {
  if (cardinality <= 0) {
    return 0;
  }
...
function seriesItemsFromNumbers(
  numbersLength,
  seriesCardinality = MIN_CARDINALITY,
  bitsPerNumber = MAX_BITS_PER_NUMBER
) {
...
function bitsSlice32(n, lowIndex, highIndex = MAX_BITS_PER_NUMBER) {
...
const CASCADED_ASCII_LEVELS_CHARSETS = (() => {
  let base = "";
...
class ASCIILevelsRSG extends CharsetLimitedRSG {
